  ...
  $(window).on("load", function () {
    ...
    $(document).ready(function () {
        ...
        $(".gi-drop-toggle").on("click", function (e) {
            ...
            if ($(senderElement).hasClass('gi-sub-drop-toggle')) return;
            if ($(senderElement).hasClass('gi-page-link')) return;
            if ($(senderElement).hasClass('condense') && $(senderElement).parents('.gi-sub-drop-toggle').length > 0) return;
